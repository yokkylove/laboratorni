...
bool ordered_array_set_isInclusion(ordered_array_set set1, ordered_array_set set2);

//проверяет, является ли set1 строгим подмножеством set2, то есть содержит ли set1 все элементы set2 и имеет
// меньшее количество элементов.
bool ordered_array_set_isStrictInclusion(ordered_array_set set1, ordered_array_set set2);
